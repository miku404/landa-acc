app.controller('l_bukubesarCtrl', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var tableStateRef;
...
//    });
    ...
    Data.get(control_link + '/listakun').then(function (data) {
...
//
//    Data.get('site/getUnitAkses').then(function (response) {
//        $scope.getCabang = $scope.allCabang = response.data.listSubUnit;
//        $scope.listUnit = response.data.listUnit;
//    });
//
//    $scope.selectUnit = function (unit) {
//        $scope.getCabang = unit.subUnit;
...
//        console.log(form)
        window.location = "api/acc/l_buku_besar/exportExcel?" + $.param(form);
    }

...
//    die();
    ...
    if ($validasi === true) {
        ...
        foreach ($getakun as $key => $val) {
            ...
            $sql->select("acc_trans_detail.kode, acc_trans_detail.debit, acc_trans_detail.kredit, acc_trans_detail.keterangan, acc_trans_detail.tanggal, m_akun.kode as kodeAkun, m_akun.nama")
                    ->from("acc_trans_detail")
                    ->join("join", "m_akun", "m_akun.id = acc_trans_detail.m_akun_id")
